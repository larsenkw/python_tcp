...
#---------------------------------- Example -----------------------------------#
#==============================================================================#
# This is an example of how the implementation could look using real variables.
# In the example presented here, the service performs an addition of two
# numbers. The request message contains the two numbers to be added and the
# response content contains the summation of those two numbers.
#==============================================================================#
#---------------------------------- Example -----------------------------------#
#==============================================================================#
...
class TCPImpl:
    ...
    def perform_service(self, content):
        ...
        x2 = content['number_2']
        sum = x1 + x2
        # The developer could simply create a new dictionary for
        # 'response_content' or follow the pattern below and use the defined
        # content dictionary from this class definition.
        self.response.content['sum'] = sum
    ...
    def client_loop(self, service_request):
        ...
        Parameters
        ----------
        service_request(content) : python function
            ...
            The input to the function should be a dictionary following the
            definition of the request content above.
        ...
        while True:
            first = 10
            second = 13.5
            self.request.content['number_1'] = first
            self.request.content['number_2'] = second
            summation = service_request(self.request.content)
            print(summation)
        #======================================================================#
        #^^^^^ USER EDIT ^^^^^
        #======================================================================#
